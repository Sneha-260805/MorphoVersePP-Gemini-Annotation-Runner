# Teammate 1 instructions

Your assignment: `assignments/teammate_1.csv` — **521 poems** across
...
git checkout -b teammate-1/gemini-generation
...
`preflight.py` should report `Assignment 1: 521` among the three
...
check `checkpoints/MV++_0001.json` exists.

If the smoke-test poem does **not** pass the stop gate, stop and read
`TROUBLESHOOTING.md` / `reports/failures/MV++_0001.json` before
